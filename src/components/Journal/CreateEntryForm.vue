    ...
    <div class="form-content-area mt-4">
      ...
      <form>
        <div class="form-group mb-4">
          ...
          <!-- by creating a new reactive ref, called currentEntry & initializing it to an empty string, currentEntry=ref('') store & adding v-model to our input  and assiging a value of currentEntry, a 2-way data binding was established btw the store and the input form, that way they always stay in-sync-->
